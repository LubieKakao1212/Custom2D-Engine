...
namespace Custom2d_Engine.Math {
    ...
    public struct TransformMatrix {
        ...
        public static void Deconstruct(in TransformMatrix mat, out Vector2 translation, out float rotation,
            out float xShear, out Vector2 scale) {
        ...
        public static TransformMatrix TranslationRotationScale(Vector2 translation, float rotationRadians,
            Vector2 scale) {
            TransformMatrix trs;
        ...
        public static TransformMatrix TranslationRotationShearScale(Vector2 translation, float rotationRadians,
            float xShear, Vector2 scale) {
