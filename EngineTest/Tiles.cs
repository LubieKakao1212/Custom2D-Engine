...
namespace EngineTest {
    public static class Tiles {
        ...
        public static readonly Tile OversizedTransparentYellow =
            new Tile() { Order = 0.2f, Tint = new Color(1f, 1f, 0f, 0.5f) };
        ...
        public static readonly Matrix2x2
            OversizedTransparentYellowTransform = new Matrix2x2(Vector2.UnitX, Vector2.One);
