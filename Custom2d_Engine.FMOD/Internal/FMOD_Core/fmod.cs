...
#pragma warning restore 414
    ...
    */
    public struct Sound {
        ...
        public RESULT get3DConeSettings(out float insideconeangle, out float outsideconeangle,
        ...
        public RESULT getSyncPointInfo(IntPtr point, out string name, int namelen, out uint offset,
            TIMEUNIT offsettype) {
            IntPtr stringMem = Marshal.AllocHGlobal(namelen);
        ...
        public RESULT getLoopPoints(out uint loopstart, TIMEUNIT loopstarttype, out uint loopend,
